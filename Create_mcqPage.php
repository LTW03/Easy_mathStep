...
<head>
    ...
    <title>Create MCQ | E.M.S</title>
    <link rel="stylesheet" href="./Css_folder/Create_mcqPage.css">
...
<body>
    ...
    <div id="helpModal" class="help_modal">
        <div class="help_modal_content">
            ...
            <video controls>
                <source src="src/User_guideVideo/MCQ.mp4" type="video/mp4">
                Your browser does not support the video tag.
            </video>
        </div>
    </div>

    <script src="./JS_Folder/Create_mcqPage.js"></script>
</body>
</html>
