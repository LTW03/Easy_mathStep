...
<head>
    ...
    <title>Create Drag And Drop | E.M.S</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" />
    <link rel="stylesheet" href="./Css_folder/Create_DGpage.css">
    <style>
    </style>
</head>
<body>
    ...
    <div class="centralize_form">
        <div class="form_container">
            <h1>Create a Quiz</h1>
            <form id="quizForm" action="./Create_DG_SavingProcess.php" method="POST" enctype="multipart/form-data">
    ...
    <div id="helpModal" class="help_modal">
        <div class="help_modal_content">
            ...
            <video controls>
                <source src="src/User_guideVideo/Drag and Drop.mp4" type="video/mp4">
...
<script src='JS_Folder/Create_dngPage.js'></script>
