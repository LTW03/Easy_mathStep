...
<head>
    ...
    <link rel="stylesheet" href="./css/add_dg.css">
    <style>
    </style>
</head>
<body>
    ...
    <div class="centralize_form">
        <div class="form_container">
            <h1>Create a Quiz</h1>
            <form id="quizForm" action="./addDGprocess.php" method="POST" enctype="multipart/form-data">
...
<script src='./JS/add_dgQuestion.js'></script>
