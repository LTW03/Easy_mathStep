...
<head>
    ...
    <title>Add Questions | E.M.S</title>
    <link rel="stylesheet" href="./css/add_mcq.css">
...
<body>
    ...
    <div class="centralize_form">
        <div class="form_container">
            <h1>Add Questions to Lesson</h1>
            <form id="questionForm" action="./add_mcq_process.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" id="lesson_id" name="lesson_id" value="<?php echo htmlspecialchars($_GET['lesson_id']); ?>">
    ...
    <script src="./js/add_mcq.js"></script>
</body>
</html>
